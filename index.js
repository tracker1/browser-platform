...
function addClasses(agent,platform) {
	platform.classNames = []
		...
		.concat(function(){
			if (!platform.os) return null;
			var v = platform.osVersion.match(/\d+\.\d+/)[0];
			if (!v) return null;
...
//exports
if (typeof module !== 'undefined' && module.exports) module.exports = getPlatform;
else if (typeof window !== 'undefined' && window == window.self) window.getBrowserPlatform = getPlatform;
else if (typeof global !== 'undefined') global.getBrowserPlatform = getPlatform;
